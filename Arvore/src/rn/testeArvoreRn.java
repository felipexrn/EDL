...
public class testeArvoreRn {
  public static void main (String[] args) {
    try {
      ...
      ArrayList<Integer> inseridos = new ArrayList<>(Arrays.asList(10, 30, 20, 40, 90, 80, 70, 60, 50));
      ArrayList<Integer> removidos = new ArrayList<>(Arrays.asList(10, 60, 30, 40, 50, 70, 20, 90, 80));
