public class testeList {
  ...
  public static void main(String[] args) {
    int in1 = 4, in2 = 10, in3 = 7, in4 = -1, in5 = -2,
      in6 = 5, in7 = 3, in8 = 9, in9 = -3, in10 = -5, in11 = -3, in12 = -4;
    List l = new List();
    ...
    System.out.println("\no elemento anterior ao elemento " + l.last() +
                       " é " + l.before(l.findElement(l.last())).getElement());

    System.out.println("\no elemento posterior ao elemento " + l.first() +
                       " é " + l.after(l.findElement(l.first())).getElement());

    System.out.println("\no elemento " + in10 +
                       " é o primeiro? " + l.isFirst(l.findElement(in10)));

    System.out.println("\no elemento " + in12 +
                       " é o último? " + l.isLast(l.findElement(in12)));

    System.out.println("\no elemento " + in12 +
                       " é o primeiro? " + l.isFirst(l.findElement(in12)));

    System.out.println("\no elemento " + in10 +
                       " é o último? " + l.isLast(l.findElement(in10)));
